...
> = {
  en: {
    heroTitle: "Procurement operations, KPI reporting and digital workflow professional focused on measurable process improvement.",
    heroSubtitle: "Purchasing support, supplier governance, dashboards and practical digital execution with a business-first mindset.",
    experienceTitle: "Professional Experience Snapshot",
    experienceDesc: "Experience across purchasing operations, procurement workflows, KPI monitoring and process coordination.",
    capabilitiesTitle: "Procurement, KPI and digital execution",
    capabilitiesDesc: "Core areas that define my current profile in corporate operations and practical digital delivery.",
    ...
    toolsDesc: "SAP, Coupa, Qlik Sense and Excel support my work in procurement operations, KPI follow-up and process visibility.",
    viewExperience: "View Experience",
    profileButton: "Professional Profile",
    capabilities: ["Procurement operations", "Purchasing support", "KPI / Reporting", "Supplier governance", "Digital workflows"],
  },
  es: {
    heroTitle: "Profesional de operaciones de procurement, reporting KPI y workflows digitales centrado en mejora de procesos medible.",
    heroSubtitle: "Soporte a purchasing, supplier governance, dashboards y ejecucion digital practica con enfoque de negocio.",
    experienceTitle: "Resumen de Experiencia Profesional",
    experienceDesc: "Experiencia en operaciones de purchasing, workflows de procurement, seguimiento KPI y coordinacion de procesos.",
    capabilitiesTitle: "Procurement, KPI y ejecucion digital",
    capabilitiesDesc: "Areas clave que definen mi perfil actual en operaciones corporativas y entrega digital practica.",
    ...
    toolsDesc: "SAP, Coupa, Qlik Sense y Excel apoyan mi trabajo en operaciones de compras, seguimiento KPI y visibilidad de procesos.",
    viewExperience: "Ver Experiencia",
    profileButton: "Perfil Profesional",
    capabilities: ["Procurement", "Soporte a purchasing", "Reporting KPI", "Supplier governance", "Workflows digitales"],
  },
};
