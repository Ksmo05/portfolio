    ...
    <div className="page-shell space-y-0 py-10 md:py-14">
      <section className="grid items-center gap-12 py-16 md:gap-16 md:py-24 lg:grid-cols-[1.08fr_0.92fr]">
        ...
        <div className="space-y-6">
          <div className="mx-auto grid w-fit gap-4 sm:grid-cols-[auto_auto] sm:items-center">
            <div className="rounded-full border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.16),rgba(255,255,255,0.03))] p-2 shadow-[0_30px_80px_-36px_rgba(2,6,23,0.95)]">
              <div className="flex h-44 w-44 items-center justify-center overflow-hidden rounded-full border border-white/14 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.18),rgba(15,23,42,0.45))] p-7 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] md:h-52 md:w-52">
                <Image src="/logo-csm.png" alt="Carlos San Miguel portfolio logo" width={280} height={280} className="h-full w-full object-contain" priority />
              </div>
            </div>
            <div className="rounded-full border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.16),rgba(255,255,255,0.03))] p-2 shadow-[0_30px_80px_-36px_rgba(2,6,23,0.95)]">
              <div className="h-52 w-52 overflow-hidden rounded-full border border-white/14 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] md:h-64 md:w-64">
