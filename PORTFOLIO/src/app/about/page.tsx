...
export const metadata: Metadata = buildMetadata({
  title: "About Carlos San Miguel Ortega",
  description:
    "Background of Carlos San Miguel Ortega across consulting, energy operations, public administration procurement, banking support, purchasing operations, and reporting.",
  path: "/about",
});
    ...
    <div className="mx-auto w-full max-w-5xl space-y-14 px-6 py-14 md:py-20">
      <section className="grid items-center gap-10 md:grid-cols-[1fr_220px]">
        <div>
          <SectionHeader
            eyebrow="About"
            title="Carlos San Miguel Ortega"
          ...
          <p className="max-w-4xl text-base text-slate-600 dark:text-slate-300">
            Operations and reporting professional with experience across consulting projects, energy operations, public administration procurement processes, and banking customer support environments.
          </p>
          <p className="mt-4 max-w-4xl text-base text-slate-600 dark:text-slate-300">
            Current work focuses on purchasing operations, vendor coordination, reporting dashboards, and structured operational support within business environments that require accuracy, process discipline, and cross-team collaboration.
          </p>
        </div>
      ...
      <section>
        <h2 className="text-2xl font-semibold">Professional Focus Areas</h2>
      ...
      <CtaSection
        ...
        description="Explore the structured sections covering professional experience, projects, and academic background."
